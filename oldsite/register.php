...
function sendConfirmation($name, $username, $email, $password){
  $msg = 'Hello '.$name.',

You are now registered on the Pittsburgh Go Association Web Site.
	
Username: '.$username.'
Password: '.$password.'

You can login here: http://pittsburghgo.com/login.php';

  return mail($email, 'PGA Web Site Registration', wordwrap($msg));
}
...
if ($logged_in){
  ...
  echo '<p>Registration is disabled right now.</p>';
